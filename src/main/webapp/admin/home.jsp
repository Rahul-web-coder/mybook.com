    ...
    <div class="main-container">
        <div class="sidebar">
            <div class="sidebar-brand">
                <h2><span class="las la-user-tie"></span> <span>CodeWithAhmed</span></h2>
            </div>
            <!-- dashboard sections  -->
        ...
        <header class="block">
            ...
            <div class="profile-menu">
                ...
                <div class="profile-picture small-profile-picture">
                    <img width="40px"  src="images/firdaus.jpg">
                </div>
            </div>
        </header>
        ...
        <div class="right-container container">
            <div class="join-newsletter block"> <!-- JOIN NEWSLETTER (RIGHT-CONTAINER) -->
                ...
                <a class="subscribe button" href="#21">VIEW USERS</a>
            </div>
             <div class="join-newsletter block"> <!-- JOIN NEWSLETTER (RIGHT-CONTAINER) -->
                <h2 class="titular">STAFF</h2>
                <div class="input-container">
                </div>
                <a class="subscribe button" href="emp-list.jsp">VIEW STAFF</a>
            </div>
             <div class="join-newsletter block"> <!-- JOIN NEWSLETTER (RIGHT-CONTAINER) -->
                <h2 class="titular">COURSES</h2>
                <div class="input-container">
                </div>
                <a class="subscribe button" href="#21">ADD COURSE</a>
            </div>
             <div class="join-newsletter block"> <!-- JOIN NEWSLETTER (RIGHT-CONTAINER) -->
                <h2 class="titular">USERS</h2>
                <div class="input-container">
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
 ...
 <!-- AJAX -->
    ...
    <script
      src="https://kit.fontawesome.com/26985e21e7.js"
