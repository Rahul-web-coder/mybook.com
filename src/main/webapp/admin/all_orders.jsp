...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<%@ page import="adminBean.admin" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
   	<title>mybook.com | All Orders</title>
...
<body>
  ...
  <section class="home-section">
    ...
    <div class="home-content">
      <div class="overview-boxes">
        ...
        <div class="box">
          <div class="right-side">
            <div class="box-topic">Returned Ordered</div>
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          <div class="title" style="text-align: center;font-size: 30px;font-weight: bolder;color:  rgb(153, 40, 59)">Orders</div>
  ...
  <thead>
    <tr>
      ...
      <th scope="col" style="text-align: center;">Buyer<br>Email</th>
      <th scope="col" style="text-align: center;">Order<br>Status</th>
      <th scope="col" style="text-align: center;">Action</th>
      
    </tr>
  </thead>
  <tbody>
  <c:forEach items="${order.getAllOrders()}" var="odr">
    <tr>
		  ...
		  <td style="text-align: center;">     
		      <select style="font-size: 13px" name="hlo">
		      ...
		      <% 
		      		...
		      		admin ad = new admin();
		      		ad.setStatus("selected");
		      %>
	      </td>	
	      
      <td> <a class="btn btn-primary" href="../updatebookservlet?id=${odr.getOrderId() }" ><i style="color: white" class="fas fa-save"></i></a></td>
  ...
  <script>
  var selected = document.getParameter("hlo");
