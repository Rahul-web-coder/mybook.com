				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="header-logo">
							<a href="home.jsp" class="logo"> <img src="./img/logo.png" alt="">
							</a>
						</div>
					</div>
					<!-- /LOGO -->
						...
						<div class="header-ctn">
							...
							<div class="dropdown">
								...
								<div class="cart-dropdown">
									...
									<div class="cart-btns">
										<a href="#">View Cart</a> <a href="checkout.jsp">Checkout <i
																...
																<div class="row">
																	<div class="col-md-4 product-name">
																		<div class="product-name">
																			<a href="#">${cart.getpName()}</a>
																			<div class="product-info">
																				<div>
																					Display: <span class="value"></span>
																				</div>
																				<div>
																					RAM: <span class="value"></span>
																				</div>
																				<div>
